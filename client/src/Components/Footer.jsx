                ...
                <div className=" flex justify-between max-md:flex-col gap-10">
                    <div className="space-y-6 w-[30%] max-md:w-full">
                        ...
                        <p className="text-gray-400 text-sm">
                            ...
                            environmental responsibility. <br /> <br /> Our vision extends beyond lighting—it’s about creating a brighter, greener
                            world where every product reflects our commitment to energy efficiency and sustainable progress. At Nessa, innovation
                            isn’t just about advancement; it’s about shaping a future that balances technological excellence with a deep respect for
                            our planet.
                        </p>
                    ...
                    <div className="w-[20%] max-md:w-full">
                        ...
                        <ul className="space-y-3">
                            ...
                            <li className="text-gray-400">
                                <strong>Registered Address : </strong>36-A, Devraj Industrial Park, Pipalaj, Pirana Rd, Piplaj, Ahmedabad, Gujarat
                                382405{' '}
                            </li>
                            <li className="text-gray-400">
