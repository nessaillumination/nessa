...
const Support = () => {
    ...
    return (
        <>
            <SEO
                title={'LED & Solar Lighting Support | Technical & Maintenance Help | Nessa'}
                ...
                primaryKeyword={["led lighting support", "lighting product support", "solar lighting support", "technical support for lighting", "lighting maintenance support"]}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full p-2 border-b-2 font-semibold outline-none focus:border-blue-800 ${errors.productName ? 'border-red-500' : 'border-gray-500'
                                            } rounded`}
                                    />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        onChange={handleInputChange}
                                        className={`w-full p-2 border-b-2 font-semibold outline-none focus:border-blue-800 ${errors.productSKUId ? 'border-red-500' : 'border-gray-500'
                                            } rounded`}
                                    />
