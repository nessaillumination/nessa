    ...
    const whyChooseNessaBoxData = [
        {
            ...
            description: `Lighting the way for over ${new Date().getFullYear() - 2008} years, trusted by industries worldwide.`
        },
        {
            title: 'Global Reach',
    ...
    return (
        <>
            ...
            <SEO
                ...
                primaryKeyword={[
                    'Led Light Manufacturers India',
                    'Led Lighting Companies in India',
                    'Solar HighMast Manufacturer',
                    'Smart light manufacturer',
            ...
            <div className="w-full  overflow-hidden">
                ...
                <div
                    className="w-full h-[70vh] relative bg-cover bg-center"
                    ...
                    <div className="absolute inset-0 flex flex-col items-center justify-center text-black px-4">
                        <div className="max-w-4xl mx-auto text-center ">
                            ...
                            <p className="text-lg md:text-xl  mb-8 max-w-2xl mx-auto">
                                With over two decades of expertise and a global presence, Nessa delivers sustainable, high performance lighting
                ...
                <div
                    ...
                    <div className="relative mt-7 text-xl px-[5vw] mb-4 leading-8 text-center text-zinc-900 max-md:max-w-full">
                        Trusted by industries worldwide, Nessa delivers customized, high-performance lighting solutions for every need. Partner with
                        Nessa for reliable, energy-efficient lighting that sets new standards in quality and sustainability.
                    </div>
                    <div>
