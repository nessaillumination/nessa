...
const Solutions = () => {
    ...
    return (
        <>
        <SEO
            title={"Industrial & Outdoor LED Lighting Solutions for India Nessa"}
            ...
            primaryKeyword={["led lighting solutions","solar lighting solutions","industrial lighting solutions","outdoor lighting solutions","energy efficient lighting solutions"]}
