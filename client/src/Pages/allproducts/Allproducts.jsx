...
const Allproducts = () => {
    return (
        <>
            <SEO
                title={"Energy Efficient LED Lighting Products | Solar & Outdoor Lights | Nessa"}
                ...
                primaryKeyword={["led lighting products", "solar lighting products", "industrial led lights", "outdoor led lights", "energy efficient lighting products"]}
            />
